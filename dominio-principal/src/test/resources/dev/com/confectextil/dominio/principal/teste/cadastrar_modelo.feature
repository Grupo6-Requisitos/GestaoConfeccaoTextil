...
Funcionalidade: Cadastro de Modelos
  ...
  Cenario: Cadastrar um novo modelo com sucesso
    Dado que eu sou um usuário "GESTOR" autenticado
    E não existe um modelo com a referência "MOD-001"
  ...
  Cenario: Tentar cadastrar um modelo com referência duplicada
    Dado que eu sou um usuário "GESTOR" autenticado
  ...
  Cenario: Listar um modelo recém-cadastrado
    Dado que eu sou um usuário "GESTOR" autenticado
    E existem os seguintes modelos já cadastrados:
      | referencia | nome                 |
      | MOD-003    | Blusa de Alcinha     |
      | MOD-004    | Calça Jeans Skinny   |
    Quando eu cadastro um novo modelo com referência "MOD-005" e nome "Shorts de Corrida"
    E eu peço a lista completa de modelos
    Entao a lista de modelos deve conter 3 itens
    E a lista de modelos deve incluir um modelo com referência "MOD-005" e nome "Shorts de Corrida"
  ...
  Cenario: Tentar cadastrar um modelo usando um insumo inexistente
    Dado que eu sou um usuário "GESTOR" autenticado
