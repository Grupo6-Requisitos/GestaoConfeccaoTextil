...
Funcionalidade: Cadastro de Parceiro
  ...
  Regra:
    - Todo parceiro deve ter um ID válido e único.
    ...
    - Não é permitido cadastrar dois parceiros com o mesmo ID.

  Cenario: Cadastrar um parceiro valido
    Dado que eu tenho um ID "P001", nome "Thiago" e telefone "81999998888"
    Quando eu cadastrar o parceiro
    Entao o parceiro com ID "P001" deve estar registrado no sistema
  ...
  Cenario: Tentar cadastrar parceiro com nome invalido
    Dado que eu tenho um ID "P002", nome "" e telefone "81999998888"
    Quando eu cadastrar o parceiro
  ...
  Cenario: Tentar cadastrar parceiro com telefone invalido
    Dado que eu tenho um ID "P003", nome "Maria" e telefone "12345"
    Quando eu cadastrar o parceiro
